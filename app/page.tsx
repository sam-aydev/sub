...
export default function Home() {
  return (
    <div>
      <div className="bg-[#333333] px-7 pt-10 pb-36">
      ...
      <div className="px-5">
        <div className="flex justify-center items-center mt-4">
          <p className="-mt-3">_________</p>
          <h2 className="text-4xl font-extrabold text-center">
            ABOUT <span className="text-[#FFC600]">LEADPLUS</span>
          </h2>
          <p className="-mt-3">__________</p>
        </div>
      ...
      <div className="px-5 mt-8 ">
        ...
        <p className="mt-5 font-semibold">
          Target the right audience in your preferred location and category. We
          provide the best B2B and B2C database that can incredibly boost the
          results of your marketing campaign. Download the database in Excel
          format with their details such as name, mobile number, email id and
          location. This is best for bulk Whatsapp, bulk email, telecalling and
          even custom Facebook Ads, Instagram Ads and Google Ads.
        </p>
        <ul className="mt-4">
          ...
          <li className="font-semibold">All India Business Owners Database</li>
      ...
      <div className="mt-10">
        <div className=" relative group">
          <div className="w-4/5 transition-all duration-500 scale-100 group-hover:scale-105 group-hover:right-4 p-4 text-2xl absolute right-0  bg-black text-white">
            <p>
              <span className="text-[#FFC600] font-bold">EXACTLY</span> WHAT YOU
              NEED TO RAECH LOCAL CUSTOMERS EXACTLY{" "}
              <span className="text-[#FFC600] font-bold">WHAT</span> YOU NEED TO
              CONVERT MORE LEADS EXACTLY WHAT{" "}
      ...
      <div className="pt-96  ">
        <div className="bg-cover  bg-black/90 bg-blend-overlay opacity-85 bg-fixed  bg-no-repeat h-[1900px] bg-hero-pattern">
          ...
          <div className="font-bold mt-9 ml-20 text-white">
            <h1 className="text-xl text-right px-1">B2B and B2C database</h1>
            <p>
              Every growing business needs a growing list of leads. We'll
              provide you the best database so you can generate more qualified
              leads.
            </p>
            <Image
              src={my1}
              ...
              height={500}
              alt="tr"
              className="size-20 transition-all duration-500 hover:rotate-[360deg]"
            />
          </div>
          <div className="font-bold mt-9 ml-20 text-white">
            <h1 className="text-xl text-right px-1">Social media Ads</h1>
            <p>
              Post highly engaging Ads on Facebook, Instagram, LinkedIn, Twitter
              and Quora – get more traffic and sales.
            </p>
            <Image
              src={my2}
              width={500}
          ...
          <div className="font-bold mt-9 ml-20 text-white">
            <h1 className="text-xl text-right px-1">Pay per click Ads</h1>
            <p>
              Whether you want to bring back your recent website visitors or
              generate new leads on Google, Bing and YouTube, PPC is the best
              option.
            </p>
            <Image
              src={my3}
          ...
          <div className="font-bold mt-9 ml-10 text-white">
            <h1 className="text-xl text-left px-1">Website Design</h1>
            <p className="mt-2">
              Do you need a quick one-page website? Or need an ecommerce site?
              We design beautiful websites that will impress your visitors at
              first glance.
            </p>
            <Image
              src={my5}
          ...
          <div className="font-bold mt-9 ml-10 text-white">
            <h1 className="text-xl text-left px-1">Viral Marketing</h1>
            <p className="mt-2">
              Let’s make your post go viral on social media. We’ll share your
              promotional post to our 1,30,000 real followers on Facebook and
              LinkedIn.
            </p>
            <Image
              src={my6}
          ...
          <div className="font-bold mt-9 ml-10 text-white ">
            <h1 className="text-xl text-left px-1">Bulk email sending</h1>
            <p className="mt-2">
      ...
      <div className="px-5">
        ...
        <div className="flex justify-center group w-full">
        ...
        <p className="font-semibold mt-4 text-lg">
          People are less likely to respond. Because you're not specific enough.
        </p>
        <p className="font-semibold mt-4 text-lg">
          But instead, what if you say "Hey, any doctor here? What do you think
          will happen?{" "}
        </p>
        <p className="font-semibold mt-4 text-lg">
          The doctor is going to respond. Because you specifically called him
          out.{" "}
        </p>
        <p className="font-semibold mt-4 text-lg">
          It's the same with your marketing message - when you try to attract
          everyone, you end up attracting almost none.{" "}
        </p>
      </div>
      ...
      <div className="mt-16 px-5">
        ...
        <p className="font-semibold mt-5">
          ...
          pricing too. Get the best of both worlds with organic Google reviews.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="w-5/6 mx-auto border border-[#FCC600] shadow-xl hover:shadow-2xl">
        ...
        <div className="mt-8 w-5/6 mx-auto border border-[#FCC600] shadow-xl hover:shadow-2xl">
        ...
        <div>
          <div className="w-5/6 mx-auto ">
            ...
            <p className="bg-slate-50 mt-3 px-3 pt-2  font-bold">
              We have collected this data from various sources and the Internet
              and the accuracy varies as per the category and source. But we
              always give you the latest. We usualy hit an accuracy of 80% to
              90% and same customers have bought from us repeatedly.
            </p>
          </div>
          <div className="w-5/6 mx-auto mt-4 ">
            ...
            <p className="bg-slate-50 mt-3 px-3 pt-2  font-bold">
              ...
              responsible for any legal matter or Loss occur to you due to usage
              of this data. If USER (Purchaser) is doing any illegal activity or
              spamming then any third party has rights to take action against
              the USER (i.e. you).
            </p>
          </div>
          <div className="w-5/6 mx-auto mt-4 ">
          ...
          <div className="w-5/6 mx-auto mt-4 ">
            ...
            <p className="bg-slate-50 mt-3 px-3 pt-2  font-bold">
              ...
              to our account, you will receive the data within24 hours.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <form action="" className="mt-8 px-10 w-full">
          <div>
            <label
              htmlFor=""
